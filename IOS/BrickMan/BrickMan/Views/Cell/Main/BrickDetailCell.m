...
@interface BrickDetailCell()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
...
@implementation BrickDetailCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        if (!_myCollectionView) {
            ...
            [_myCollectionView registerClass:[BrickDetailPhotoCell class] forCellWithReuseIdentifier:kCellIdentifier_BrickDetailPhotoCell];
...
- (void)layoutSubviews {
    ...
    for (BMAttachment *attachment in self.model.brickContentAttachmentList) {
        collectionViewHeight += [BrickDetailPhotoCell cellHeithWithAttachment:attachment].height;
    }
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    BrickDetailPhotoCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:kCellIdentifier_BrickDetailPhotoCell forIndexPath:indexPath];
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout*)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
    return [BrickDetailPhotoCell cellHeithWithAttachment:self.model.brickContentAttachmentList[indexPath.row]];
}
...
+ (CGFloat)cellHeightWithModel:(BMContent *)contentModel {
    ...
    CGFloat collectionViewHeight = 0;
    for (BMAttachment *attachment in contentModel.brickContentAttachmentList) {
        collectionViewHeight += [BrickDetailPhotoCell cellHeithWithAttachment:attachment].height;
    }
