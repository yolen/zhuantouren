...
public class BricksListActivity extends BaseActivity<BricksListPresenter, BricksListModel> implements BricksListContract.View {
                ...
                mRecyclerView.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (mPageNo >= mPageSize) {
                            ...
                            mPresenter.loadBricksList(mPageNo);
                        }
                    }
                });
            }
    ...
    @Override
    public void loadSuccess(List<BricksBean> bricksList, int pageSize, boolean hasMore) {
        mPageSize = pageSize;
        if (mPageNo == 0) {
            ...
            mAdapter.notifyDataChangedAfterLoadMore(bricksList, true);
        }
    }
